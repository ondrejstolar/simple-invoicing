...
function downloadPdf(invoice) {
  var filename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'download.pdf';
  try {
    var blob = base64ToBlob(invoice);
...
function renderPdf(input, targetDivId) {
  try {
    ...
    if (!targetDiv) throw new Error("Div with id \"".concat(targetDivId, "\" not found."));
    targetDiv.innerHTML = '';
